    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          <Link
            to="/"
            className="flex items-center justify-center space-x-2 text-2xl font-bold text-blue-600 dark:text-blue-400 mb-8"
          >
            <svg
              className="w-8 h-8"
              fill="currentColor"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-8">
          <div className="text-center">
            ...
            <p className="text-xs text-gray-600 dark:text-gray-300">Fast Processing</p>
          </div>
          <div className="text-center">
            ...
            <p className="text-xs text-gray-600 dark:text-gray-300">Secure & Private</p>
          </div>
          <div className="text-center">
            ...
            <p className="text-xs text-gray-600 dark:text-gray-300">Free to Use</p>
          </div>
        </div>
      </div>
    </div>
