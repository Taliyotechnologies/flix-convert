    ...
    <div className="home-details animate-details" style={{marginTop: '2.5rem'}}>
      ...
      <div className="about-owner-card">
        <div className="about-owner-avatar">
          <svg width="56" height="56" fill="none" viewBox="0 0 56 56"><circle cx="28" cy="20" r="12" fill="#3B82F6"/><rect x="12" y="36" width="32" height="12" rx="6" fill="#2CB67D"/></svg>
        </div>
        <div>
          <h3 style={{margin: 0, color: '#3B82F6'}}>Taliyo Technologies</h3>
