      ...
      <section className="upload-section">
        <div className="upload-container">
          <div className="upload-area" onClick={() => document.getElementById('file-input').click()}>
            ...
            <p>Drag and drop or click to select a video for compression</p>
        ...
        <section className="compression-settings">
          <div className="settings-container">
            <div className="settings-header">
              ...
              <p>Configure your video compression preferences for optimal results</p>
            </div>
        ...
        <section className="results-section">
          <div className="results-container">
            <div className="results-header">
              ...
              <p>Your video has been successfully compressed</p>
            </div>
      ...
      <section className="features-section">
        <div className="features-container">
          <div className="features-header">
            <h2>Why Choose Our Professional Video Compression?</h2>
            <p>Advanced technology meets user-friendly design for the best video compression experience</p>
          </div>
          <div className="features-grid">
            <div className="feature-card">
              ...
              <p>State-of-the-art video compression algorithms ensure optimal file size reduction while maintaining the highest possible quality.</p>
            </div>
            <div className="feature-card">
              <div className="feature-icon">
                <svg width="56" height="56" viewBox="0 0 56 56" fill="none">
              ...
              <p>Fine-tune compression settings with real-time preview to achieve the perfect balance between file size and video quality.</p>
            </div>
            <div className="feature-card">
              <div className="feature-icon">
                <svg width="56" height="56" viewBox="0 0 56 56" fill="none">
