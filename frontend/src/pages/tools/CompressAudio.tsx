...
import { Upload, Download, Music, X, Settings, Info, Zap } from 'lucide-react';
import './ToolPage.css';
  ...
  const processAudio = async () => {
    ...
    setTimeout(() => {
      ...
      const processedFile = new File([uploadedFile], 
        ...
        { type: `audio/${compressionSettings.format}` }
      );
        ...
        <div className="container">
          <div className="tool-header-content">
            ...
            <div className="tool-info">
              ...
              <p>Reduce audio file size while maintaining quality. Support for MP3, WAV, FLAC, and more.</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="container">
          <div className="info-grid">
            <div className="info-card">
              <Info size={24} />
              <h4>Free Tier</h4>
              <p>Compress audio up to 10MB for free. No registration required.</p>
            </div>
            <div className="info-card">
              <Music size={24} />
              <h4>Multiple Formats</h4>
              <p>Support for MP3, WAV, FLAC, AAC, OGG, and more audio formats.</p>
            </div>
            <div className="info-card">
              <Settings size={24} />
              <h4>Quality Control</h4>
              <p>Adjust quality and bitrate settings for optimal compression.</p>
            </div>
          </div>
        </div>
      </div>
