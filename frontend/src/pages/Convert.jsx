...
const convertOptions = [
  {
    ...
    label: 'Image Convert',
    desc: 'Convert images between formats instantly.'
  },
  {
    href: '/convert/video',
    icon: (
    ...
    label: 'Video Convert',
    desc: 'Convert videos between formats instantly.'
  },
  {
    href: '/convert/audio',
    icon: (
    ...
    label: 'Audio Convert',
    desc: 'Convert audio files between formats instantly.'
  },
  {
    href: '/convert/pdf',
    icon: (
    ...
    label: 'PDF Convert',
    desc: 'Convert PDF files to and from other formats.'
  }
];
...
const Convert = () => (
  <section className="home">
    <div className="home-hero animate-hero">
      <h1 className="animate-title">Convert Files</h1>
      <p className="home-subtitle animate-subtitle">Convert images, videos, audio, and PDFs between formats instantly. Fast, secure, and high quality.</p>
    </div>
    <div className="modern-cards" style={{marginTop: '2.5rem'}}>
      {convertOptions.map((item) => (
