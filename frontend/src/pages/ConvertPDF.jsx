...
import { FiUpload, FiDownload, FiFileText, FiSettings } from 'react-icons/fi';
...
const ConvertPDF = () => {
  ...
  const formats = [
    ...
    { value: 'html', label: 'HTML', description: 'Web format' },
    { value: 'rtf', label: 'RTF', description: 'Rich text' },
    { value: 'odt', label: 'ODT', description: 'OpenDocument' },
  ...
  const handleConvert = async () => {
    ...
    setTimeout(() => {
      ...
      setConvertedFile({
        name: selectedFile.name.replace('.pdf', `.${targetFormat}`),
        size: selectedFile.size * 0.6,
      ...
      <div className="container">
        <div className="page-header">
          ...
          <p className="page-subtitle">
            Convert your PDF files to different formats with high accuracy
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="card">
            ...
            <div className="space-y-6">
              <div className="upload-area" onClick={() => document.getElementById('pdf-input').click()}>
                <input
                  id="pdf-input"
                  type="file"
                  accept=".pdf"
        ...
        {/* Features Section */}
        <div className="mt-12">
          <h2 className="text-2xl font-bold text-center mb-8">Why Choose Our PDF Converter?</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="card text-center">
              ...
              <p className="text-sm text-gray-600">
                Maintain text formatting and layout during conversion
              </p>
            </div>
            <div className="card text-center">
              ...
              <p className="text-sm text-gray-600">
                Convert to DOCX, TXT, HTML, RTF, ODT, and EPUB formats
              </p>
            </div>
            <div className="card text-center">
              ...
              <p className="text-sm text-gray-600">
                Quick conversion with our optimized OCR engine
              </p>
            </div>
          </div>
        </div>
