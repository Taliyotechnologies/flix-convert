...
const Footer: React.FC = () => {
  ...
  const footerLinks = {
    tools: [
      ...
      { name: 'Convert Video', href: '/convert/video' },
      { name: 'Convert PDF', href: '/convert/pdf' },
      { name: 'Convert Audio', href: '/convert/audio' },
      { name: 'Compress Files', href: '/compress' }
    ],
    company: [
      { name: 'About Us', href: '/company/about' },
      { name: 'Contact', href: '/company/contact' },
      { name: 'Leadership', href: '/company/owners' },
          ...
          <div className="footer-main">
            <div className="footer-brand">
              ...
              <p className="footer-description">
                Professional file conversion and compression tools. 
                Convert images, videos, PDFs, and audio files with ease.
              </p>
